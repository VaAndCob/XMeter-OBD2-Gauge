...
RET
;********************************
SERINIT1:DB "ATSP6",0Dh,00h	;set OBDII Protocal6 (can bus)
SERINIT2:DB "ATE0",0Dh,00h		;set Echo off
SERINIT3:DB "ATL0",0Dh,00h		;set Lind Feed off
SERINIT4:DB "ATH0",0Dh,00h		;set Msg Header  off
SERINIT5:DB "ATST01",0DH,00h	;set wait time = 4 msec
...
TITLE4:DB  "Now connecting.....",0Dh,00h

MENU1:DB "Select SET UP ITEM ~ ",0Dh,00h
MENU2:DB "Change Setting Val ~",0Dh,00h
...
NODATA:DB "-NO DATA!  NO DATA!-",0Dh,00
END